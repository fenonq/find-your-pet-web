    ...
    public partial class InitialIdentityMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pets_pk", x => x.id);
                    table.ForeignKey(
                        name: "fc_user",
                        column: x => x.owner_id,
                        principalTable: "AspNetUsers",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("image_pk", x => x.id);
                    table.ForeignKey(
                        name: "fc_pet",
                        column: x => x.pet_id,
                        principalTable: "Pets",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityAlwaysColumn),
                    lost_date = table.Column<DateOnly>(type: "date", nullable: false),
                    location = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    contact_number = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
